...
export class Item extends MyObject3D {
  ...
  private _makeColors():void {
    ...
    for(let i = 0; i < 20; i++) {
        ...
        // this._colors.push(new Color(Util.instance.random(0, 1), 1, 1))
    }
  }
  ...
  protected _update():void {
    ...
    uni.useMouse.value += (useMouseTg - uni.useMouse.value) * 0.5
  ...
  public getGeo():BufferGeometry {
    ...
    while(itemKey < pNum) {
      ...
      // const bunkatu2 = Util.instance.randomArr([20, 3])
